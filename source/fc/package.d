...
mixin(joinFnBinds((){
	FnBind[] ret = [
		...
		{q{FcBool}, q{FcObjectSetAdd}, q{FcObjectSet* os, const(byte)* object}},
		...
		{q{const(FcObjectType)*}, q{FcNameGetObjectType}, q{const(byte)* object}},
		{q{const(FcConstant)*}, q{FcNameGetConstant}, q{const(char)* string}},
		{q{const(FcConstant)*}, q{FcNameGetConstantFor}, q{const(char)* string, const(byte)* object}},
		...
		{q{FcBool}, q{FcPatternAdd}, q{FcPattern* p, const(byte)* object, FcValue value, FcBool append}},
		{q{FcBool}, q{FcPatternAddWeak}, q{FcPattern* p, const(byte)* object, FcValue value, FcBool append}},
		{q{FcResult}, q{FcPatternGet}, q{const(FcPattern)* p, const(byte)* object, int id, FcValue* v}},
		{q{FcResult}, q{FcPatternGetWithBinding}, q{const(FcPattern)* p, const(byte)* object, int id, FcValue* v, FcValueBinding* b}},
		{q{FcBool}, q{FcPatternDel}, q{FcPattern* p, const(byte)* object}},
		{q{FcBool}, q{FcPatternRemove}, q{FcPattern* p, const(byte)* object, int id}},
		{q{FcBool}, q{FcPatternAddInteger}, q{FcPattern* p, const(byte)* object, int i}},
		{q{FcBool}, q{FcPatternAddDouble}, q{FcPattern* p, const(byte)* object, double d}},
		{q{FcBool}, q{FcPatternAddString}, q{FcPattern* p, const(byte)* object, const(char)* s}},
		{q{FcBool}, q{FcPatternAddMatrix}, q{FcPattern* p, const(byte)* object, const(FcMatrix)* s}},
		{q{FcBool}, q{FcPatternAddCharSet}, q{FcPattern* p, const(byte)* object, const(FcCharSet)* c}},
		{q{FcBool}, q{FcPatternAddBool}, q{FcPattern* p, const(byte)* object, FcBool b}},
		{q{FcBool}, q{FcPatternAddLangSet}, q{FcPattern* p, const(byte)* object, const(FcLangSet)* ls}},
		{q{FcBool}, q{FcPatternAddRange}, q{FcPattern* p, const(byte)* object, const(FcRange)* r}},
		{q{FcResult}, q{FcPatternGetInteger}, q{const(FcPattern)* p, const(byte)* object, int n, int* i}},
		{q{FcResult}, q{FcPatternGetDouble}, q{const(FcPattern)* p, const(byte)* object, int n, double* d}},
		{q{FcResult}, q{FcPatternGetString}, q{const(FcPattern)* p, const(byte)* object, int n, char** s}},
		{q{FcResult}, q{FcPatternGetMatrix}, q{const(FcPattern)* p, const(byte)* object, int n, FcMatrix** s}},
		{q{FcResult}, q{FcPatternGetCharSet}, q{const(FcPattern)* p, const(byte)* object, int n, FcCharSet** c}},
		{q{FcResult}, q{FcPatternGetBool}, q{const(FcPattern)* p, const(byte)* object, int n, FcBool* b}},
		{q{FcResult}, q{FcPatternGetLangSet}, q{const(FcPattern)* p, const(byte)* object, int n, FcLangSet** ls}},
		{q{FcResult}, q{FcPatternGetRange}, q{const(FcPattern)* p, const(byte)* object, int id, FcRange** r}},
		...
		{q{FcBool}, q{FcPatternFindIter}, q{const(FcPattern)* pat, FcPatternIter* iter, const(byte)* object}},
